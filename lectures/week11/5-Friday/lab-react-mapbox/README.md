...
Watch and follow along with this mapbox tutorial

https://www.youtube.com/watch?v=JJatzkPcmoI&list=LL&index=60&t=748s



When you've completed watching the tutorial, create the same type of map for bike parks in Houston.  Here is the data for the Housotn Bike Parks.  If you want to create a bike park map for your city, you can find the coordinates for each park on goolge.
